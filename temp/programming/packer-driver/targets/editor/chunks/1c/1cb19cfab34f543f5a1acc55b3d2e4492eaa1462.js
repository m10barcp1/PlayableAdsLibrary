    ...
    execute: function () {
      ...
      _export("SplineFollower", SplineFollower = (_dec = ccclass('SplineFollower'), _dec2 = menu('Spline/SplineFollower'), _dec3 = property({
        ...
        update(dt) {
          ...
          if (len <= 0) return;
          const v = this.speedMode === FollowSpeedMode.Speed ? this.speed : this.duration > 1e-4 ? len / this.duration : 0;
...
//# sourceMappingURL=1cb19cfab34f543f5a1acc55b3d2e4492eaa1462.js.map