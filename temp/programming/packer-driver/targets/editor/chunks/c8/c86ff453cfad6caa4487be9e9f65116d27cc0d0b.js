System.register(["__unresolved_0", "cc", "cc/env"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      menuPathReg = /^([^\x00-\x1F\x7F\s\/]+\/)*[^\x00-\x1F\x7F\s]+$/u;
      ...
      (function (_bh, _dec, _dec2, _class, _class2, _descriptor) {
        ...
        let ScriptableAsset = (_dec = ccclass("ScriptableAsset"), _dec2 = property({
          displayName: "Script",
          type: Script,
          ...
          static async createAsset(assetType, filePath) {
            if (EDITOR) {
              if (!filePath) {
...
//# sourceMappingURL=c86ff453cfad6caa4487be9e9f65116d27cc0d0b.js.map